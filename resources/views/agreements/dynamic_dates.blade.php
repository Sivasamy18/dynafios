...
@foreach($start_date_list as $list)
    @if(strtotime($list) <=strtotime($dates->end_date))
        <div>
            <div class="col-xs-1"></div>
            <div class="col-xs-2">
                <input style="border-color: transparent;padding-top: 5px;width: 130px;"
                       type="text" id="date_div" name="date_div_{{$i}}" value="{{$list}}" readonly/>
            </div>
            ...
            <div class="col-xs-4 form-group">
                <select name="pm_phisicians_{{$i}}" class="form-control">
                    <option value="0"></option>
