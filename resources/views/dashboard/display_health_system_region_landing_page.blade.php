...
<style>
    ...
    .loaderByRegions, .loaderByFacility {
        margin: 10% auto;
    }
...
@section('links')
    <div class="appDashboardFilters col-md-12">
        ...
        <div class="col-md-3 padding_none">
            <div class="form-group  col-xs-12">
                <label class="col-xs-4 control-label lable-align padding_none text_align_left">Start Date: </label>
                <div class="col-md-8 col-sm-8 col-xs-8">
        ...
        <div class="col-md-3 padding_none">
            <div class="form-group col-xs-12">
                <label class="col-xs-4 control-label lable-align padding_none text_align_left">End Date: </label>
                <div class="col-md-8 col-sm-8 col-xs-8">
    ...
    <div id="pie_chart_container" class="pie_chart_container">
        <div class="pie_chart_inner_container">
            <div id="gauge_chart1_heading" class="pie_chart_heading">
                ...
                <div id="gauge_chart1_heading_text" class="pie_chart_heading_text">
                    <!--<img class="img-responsive" src="../assets/img/default/activeContractTypes.png" alt="">-->
                    Contract Spend Effectiveness
                </div>
            </div>
        ...
        <div class="pie_chart_inner_container">
            <div id="gauge_chart2_heading" class="pie_chart_heading">
                ...
                <div id="gauge_chart2_heading_text" class="pie_chart_heading_text">
                    <!--<img class="img-responsive" src="../assets/img/default/contractSpendYearDate.png" alt="">-->
                    Contract Spend To Actual
                </div>
            </div>
        ...
        <div class="pie_chart_inner_container">
            <div id="pie_chart3_heading" class="pie_chart_heading">
                ...
                <div id="pie_chart3_heading_text" class="pie_chart_heading_text">
                    <!--<img class="img-responsive" src="../assets/img/default/totalContractSpend.png" alt="">-->
    ...
    <div id="gauge_chart_container" class="pie_chart_container">
        <div class="pie_chart_inner_container">
            <div id="pie_chart1_heading" class="pie_chart_heading">
                ...
                <div id="pie_chart1_heading_text" class="pie_chart_heading_text">
                    <!--<img class="img-responsive" src="../assets/img/default/activeContractTypes.png" alt="">-->Active
                    Contract Types
                </div>
            </div>
        ...
        <div class="pie_chart_inner_container">
            <div id="pie_chart2_heading" class="pie_chart_heading">
                ...
                <div id="pie_chart2_heading_text" class="pie_chart_heading_text">
                    <!--<img class="img-responsive" src="../assets/img/default/contractSpendYearDate.png" alt="">-->
                    Contract Spend Year To Date
                </div>
            </div>
    ...
    <div class="contractOverview text-center pie_chart_container">
        <div class="expiringAggrement">
            <!--<h3 class="overviewHeading clearfix">Contracts by Facility</h3>-->
