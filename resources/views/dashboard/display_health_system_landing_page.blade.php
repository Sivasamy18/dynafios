	...
	<div class="appDashboardFilters col-md-12">
			...
			<div class="col-md-4 padding_none">
						<div class="form-group col-xs-12">
							<label class="col-xs-4 control-label lable-align padding_none text_align_left">Region: </label>
						...
						<div class="col-md-4 padding_none">
								...
								<div class="col-md-4 healthsystemReportsButton">
									<div class="form-group col-xs-12 padding_none">
										<a style="float:right" href="{{route('healthSystem.activeContractsReport',$group_id)}}">Reports</a>
						...
						<div class="col-md-12">
							<div class="col-md-4 padding_none">
								<div class="form-group col-xs-12">
									<label class="col-xs-4 control-label lable-align padding_none text_align_left" style="text-align:left">Start Date: </label>
									<div class="col-md-8 col-sm-8 col-xs-8">
							...
							<div class="col-md-4 padding_none">
								<div class="form-group col-xs-12">
									<label class="col-xs-4 control-label lable-align padding_none text_align_left" style="text-align:left">End Date: </label>
									<div class="col-md-8 col-sm-8 col-xs-8">
						...
						<div id="pie_chart_container" class="pie_chart_container">
							<div class="pie_chart_inner_container">
								<div id="gauge_chart1_heading" class="pie_chart_heading">
									...
									<div id="gauge_chart1_heading_text" class="pie_chart_heading_text">Contract Spend Effectiveness</div>
								</div>
							...
							<div class="pie_chart_inner_container">
								<div id="gauge_chart2_heading" class="pie_chart_heading">
									...
									<div id="gauge_chart2_heading_text" class="pie_chart_heading_text">Contract Spend To Actual</div>
								</div>
							...
							<div class="pie_chart_inner_container">
								<div id="pie_chart3_heading" class="pie_chart_heading">
									...
									<div id="pie_chart3_heading_text" class="pie_chart_heading_text">Contract Effectiveness</div>
								</div>
						...
						<div id="gauge_chart_container" class="pie_chart_container">
								<div class="countStatus">
									<div id="pie_chart1_heading" class="pie_chart_heading">
										...
										<div id="pie_chart1_heading_text" class="pie_chart_heading_text">Active Contracts By Region</div>
									</div>
							...
							<div class="pie_chart_inner_container">
								<div id="pie_chart3_heading" class="pie_chart_heading">
									<div id="pie_chart3_icon"></div>
									<div id="pie_chart3_heading_text" class="pie_chart_heading_text">Contracts With No Payments</div>
								</div>
						...
						<div class="contractOverview text-center pie_chart_container">
								<div class="pie_chart_inner_container">
									<div id="pie_chart1_heading" class="pie_chart_heading">
										<div id="pie_chart1_icon"></div>
										<div id="pie_chart1_heading_text" class="pie_chart_heading_text">Active Contract Types</div>
									</div>
								...
								<div class="pie_chart_inner_container">
									<div id="pie_chart2_heading" class="pie_chart_heading">
										...
										<div id="pie_chart2_heading_text" class="pie_chart_heading_text">Overall Spend - All Contracts Year To Date</div>
									</div>
							...
							$(document).ready(function (){
								...
								$("#region").change(function (){
									...
									$.ajax({
										...
										$.each(response.sorted_array, function (index, value) {
