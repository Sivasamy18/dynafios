...
<table class="table table-striped table-hover hospital-reports-table">
    ...
    <tr>
        <td>
            <a href="{{ route('practices.managerReport', [$practice->id, $report->id]) }}">
        ...
        <td class="text-right rowlink-skip">
            <div class="btn-group btn-group-xs">
                <a class="btn btn-default btn-delete"
                   href="{{ URL::route('practices.delete_managerReport', [ $practice->id, $report->id ]) }}">
...
<div class="panel panel-default">
    <div class="panel-body">
        There are no hospital breakdown reports to display at this time.
    </div>
</div>
@endif