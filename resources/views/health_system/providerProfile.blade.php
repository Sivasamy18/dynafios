...
@section('content')
    <div class="filters clearfix">
        <a href="{{ URL::route('healthSystem.activeContractsReport',$group) }}">Active Contracts</a>
        <a class="" href="{{ URL::route('healthSystem.spendYTDEffectivenessReport',$group) }}">Spend YTD and Effectiveness</a>
        <a class="" href="{{ URL::route('healthSystem.contractsExpiringReport',$group) }}">Contract Expiring</a>
        <a class="active" href="{{ URL::current() }}">Provider Profile</a>
    </div>
