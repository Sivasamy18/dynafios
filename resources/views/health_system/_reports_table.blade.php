...
<table class="table table-striped table-hover hospital-reports-table">
    ...
    <tr>
        <td>
            <a href="{{ URL::route('healthSystem.report',  [$report->id, $group]) }}">
        ...
        <td class="text-right rowlink-skip">
            <div class="btn-group btn-group-xs">
                <a class="btn btn-default btn-delete"
                   href="{{ URL::route('healthSystem.delete_report', [$report->id, $group]) }}">
...
<div class="panel panel-default">
    <div class="panel-body">
        There are no health system reports to display at this time.
    </div>
</div>
@endif
