...
@section('content')
    <div class="filters clearfix">
        <a class="" href="{{ URL::route('compliance.complianceReport', $group) }}">Physician</a>
        <a class="active" href="{{ URL::current() }}">Practice</a>
        <a href="{{ URL::route('compliance.contractTypeReport', $group) }}">Contract Type</a>
    </div>
