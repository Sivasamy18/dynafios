...
<div class="page-header">
    <h3>
        <i class="fa fa-plus-circle fa-fw icon"></i> Practice Type
    </h3>

    <div class="btn-group btn-group-sm">
        <a class="btn btn-default" href="{{ URL::route('practice_types.index') }}"><i
                class="fa fa-arrow-circle-left fa-fw"></i> Back</a>
    </div>
</div>
@include('layouts/_flash')
{{ Form::open([ 'class' => 'form form-horizontal form-edit-action' ]) }}
<div class="panel panel-default">
    <div class="panel-heading">Create Practice Type</div>
