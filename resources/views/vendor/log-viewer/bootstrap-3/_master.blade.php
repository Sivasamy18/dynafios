        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="{{ url('/') }}" class="navbar-brand">
                    <i class="fa fa-fw fa-mobile-phone"></i> Dynafios App Dashboard
                </a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    <li class="{{ Route::is('admin.dashboard.index') ? 'active' : '' }}">
                        <a href="{{ route('admin.dashboard.index') }}">
                            <i class="fa fa-caret-square-o-down"></i> Admin Panel Dashboard
                        </a>
                    </li>
                    <li class="{{ Route::is('log-viewer::dashboard') ? 'active' : '' }}">
                        <a href="{{ route('log-viewer::dashboard') }}">
                            <i class="fa fa-dashboard"></i> App Log Dashboard
                        </a>
                    </li>
