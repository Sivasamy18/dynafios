                                ...
                                <span class="input-group-btn">
                                    @unless (is_null($query))
                                        <a href="{{ route('log-viewer::logs.show', [$log->date]) }}" class="btn btn-default">
                                            (:count results', ['count' => $entries->count()])) <span class="glyphicon glyphicon-remove"></span>
                                        </a>
                                    @endunless
            ...
            <div class="panel panel-default">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center">
                                        <span class="label label-default">The list of logs is empty!</span>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                ...
                @if ($entries->hasPages())
                    <div class="panel-footer">
                        ...
                        <span class="label label-info pull-right">
                            Page :current of :last', ['current' => $entries->currentPage(), 'last' => $entries->lastPage()])
                        </span>
                    </div>
                @endif
            </div>
            ...
            <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Are you sure you want to delete this log file: :date ?', ['date' => $log->date])</p>
                    </div>
