...
@section('body')
    ...
    <p>Dear {{ $name }},</p>
    <p>
        This message is to notify you that there are currently approved Payments pending your review in DYNAFIOS.
    </p>
	...
	<p>
        ...
        to go to the DYNAFIOS dashboard to review and approve payments.
    </p>
