...
<div class="panel panel-default">
    <div class="panel-heading">Edit Action</div>
    <div class="panel-body">
        <div class="form-group">
            <label class="col-xs-2 control-label">Name</label>

            <div class="col-xs-5">
                {{ Form::text('name', Request::old('name', $action->name), ['class' => 'form-control']) }}
            </div>
        ...
        <!-- Action-Redesign by 1254 -->
            <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            {{ Form::select('category', $categories, Request::input('category',$action->category_id), [ 'class' => 'form-control' ])
                            }}
                        </div>
            </div>
     <!--   <div class="form-group">
            ...
            <div class="col-xs-5">
                {{-- Form::select('action_type', $actionTypes, Request::old('action_type', $action->action_type_id),
                ['class' => 'form-control']) --}}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-5">
                {{-- Form::select('payment_type', $paymentTypes, Request::old('payment_type', $action->payment_type_id),
                ['class' => 'form-control']) --}}
            </div>
        </div> 
    </div> !-->
