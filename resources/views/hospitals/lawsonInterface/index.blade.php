...
@section("content")
    <div class="filters clearfix">
        ...
        <a class="active" href="{{ URL::current() }}">Interface</a>
        @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Delete Lawson Interface Report?</h4>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete this Lawson interface report?</p>
                </div>
