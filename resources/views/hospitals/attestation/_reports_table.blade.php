...
<table class="table table-striped table-hover hospital-reports-table">
    ...
    <tr>
        <td>
            <a href="{{ URL::route('attestation.report', [ $hospital->id, $report->id]) }}">
        ...
        <td class="text-right rowlink-skip">
            <div class="btn-group btn-group-xs">
                <a class="btn btn-default btn-delete"
                   href="{{ URL::route('attestation.delete_report', [ $hospital->id, $report->id ]) }}">
...
<div class="panel panel-default">
    <div class="panel-body">
        There are no attestations reports to display at this time.
    </div>
</div>
@endif