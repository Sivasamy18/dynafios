...
@section("content")
    <div class="filters clearfix">
        ...
        <a class="active" href="{{ URL::current() }}">Physician logs</a>
        ...
        <a style="display:block" class="" href="{{ URL::route('hospitals.breakdown', $hospital->id) }}">Payment summary</a>
    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("change", "[name=contract_type]", function(event) { $('[name=select_all]').attr('checked', false);
