...
@section("content")
    <div class="filters clearfix">
        ...
        <a class="active" href="{{ URL::current() }}">Active Contracts</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Delete Active Contracts Report?</h4>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete this Active Contracts report?</p>
                </div>
