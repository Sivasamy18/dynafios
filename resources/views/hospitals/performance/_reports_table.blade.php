...
<table class="table table-striped table-hover hospital-reports-table">
    ...
    <tr>
        <td>
            <a href="{{ URL::route('performance.getReport',  [$report->id]) }}">
        ...
        <td class="text-right rowlink-skip">
            <div class="btn-group btn-group-xs">
                <a class="btn btn-default btn-delete"
                   href="{{ URL::route('performance.delete_report', [$report->id ]) }}">
...
<div class="panel panel-default">
    <div class="panel-body">
        There are no Performance reports to display at this time.
    </div>
</div>
@endif
