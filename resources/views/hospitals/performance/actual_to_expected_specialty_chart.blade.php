...
<script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ['Specialty', 'Count',{type: 'string', role: 'tooltip'} @if(count($type_data) > 0) ,{type: 'number', role: 'id'} @endif],
            ...
            var chart = new google.visualization.PieChart(document.getElementById('donutchart_specialty_actual_to_expected'));
			...
			function selectHandler() {
				...
				if (selectedItem) {
					...
					$.ajax({
						url:'/getActualToExpectedPopUp/' + $("#regions").val() + '/'+ $("#hospital").val() + '/' + $("#practice_type").val() + '/' + $("#contract_type_actual").val() + '/' + $("#specialty_actual").val() + '/' + 0 + '/' + $("#group_id").val(),
						type:'get',
...
<div id="donutchart_specialty_actual_to_expected">
</div>
