...
<script type="text/javascript">
        ...
        function drawChart() {
            ...
            var chart = new google.visualization.PieChart(document.getElementById('donutchart_providers_actual_to_expected'));
			...
			function selectHandler() {
				...
				$.ajax({
					url:'/getActualToExpectedPopUp/' + $("#regions").val() + '/'+ $("#hospital").val() + '/' + $("#practice_type").val() + '/' + $("#contract_type_actual").val() + '/' + $("#specialty_actual").val() + '/' + $("#provider_actual").val() + '/' + $("#group_id").val(),
					type:'get',
...
<div id="donutchart_providers_actual_to_expected">
</div>
