...
<script type="text/javascript">
        ...
        function drawChart() {
            ...
            var chart = new google.visualization.PieChart(document.getElementById('donutchart_specialty'));
			...
			function selectHandler() {
				...
				if (selectedItem) {
					...
					$.ajax({
						url:'/getManagementDutyPopUp/' + $("#regions").val() + '/'+ $("#hospital").val() + '/' + $("#practice_type").val() + '/' + $("#contract_type").val() + '/' + $("#specialty").val() + '/' + 0 + '/' + $("#group_id").val() + '/' + category_id,
						type:'get',
