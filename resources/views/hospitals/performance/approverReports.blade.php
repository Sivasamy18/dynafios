...
@section('content')
    <div class="filters clearfix">
        <a class="" href="{{ URL::route('performance.report') }}">Physician</a>
        <a class="active" href="{{ URL::current()}}">Approver</a>
    </div>
...
@section('scripts')
    <script type="text/javascript">
        $(function () {
            ...
            $(document).on("change", "[class=approvers]", function(event) {
                Dashboard.updatePerformanceApproverReportsForm(); 
			});
        });
    </script>
@endsection
