...
<div class="panel panel-default">
    ...
    <div class="panel-heading" @if(is_physician()) style="background-image: linear-gradient(to bottom,#F5F9FF 0,#F5F9FF 100%);" @endif>
        @if(is_physician())
            <b>@if($contract->payment_type_id == 4) wRVU Approval @else Log Approval @endif</b>
            @if(($annually_attestation_questions|| $monthly_attestation_questions) && ($contract->contract_type_id == 20) && ($contract->state_attestations_annually || $contract->state_attestations_monthly))
                <a class="btn btn-primary" style="margin-top: -7px;" name="btnApprove" id="btnApprove" href="{{ URL::route('attestations.physician', [$physician_id, $contract->id, '']) }}">
                    @if($contract->payment_type_id == 4) Approve wRVUs @else {{Lang::get('physicians.title_text_approve_logs')}} @endif
                </a>
            @else
                <a class="btn btn-primary" style="margin-top: -7px;" name="bntApprove" id="bntApprove" href="{{ URL::route('physicians.signatureApprove', [$physician_id,$contract->id, '']) }}">
                    @if($contract->payment_type_id == 4) Approve wRVUs @else {{Lang::get('physicians.title_text_approve_logs')}} @endif
                </a>
            @endif
        @else
        ...
        @if(is_physician())
            ...
            <select class="form-control" id="dateSelector" name="dateSelector">
                @foreach($date_selectors as $date_selector)
                    <option value="{{$date_selector}}">{{$date_selector}}</option>
                @endforeach
            </select>
        @else
            <!-- <b>Filter by Month:</b> -->
            ...
            <div class="approveLogs" id="approve_log">
                @foreach($hourly_summary as $hourly_summary)
                    <div class="col-xs-12" style="padding-left: 0px; padding-right: 0px; background-color:black; color:white;">
                        <div class="col-xs-3 control-label" style="">Worked : <span>{{$hourly_summary['worked_hours']}}</span></div>
                        <div class="col-xs-9 control-label" style="text-align:left;">Annual Remaining : <span>{{$hourly_summary['annual_remaining']}}</span></div>
                    </div>
                    <div class="col-xs-12" style="padding-left: 0px; padding-right: 0px; background-color:black; color:white;">
                        <div class="col-xs-3 control-label" style="">Remaining : <span>{{$hourly_summary['remaining_hours']}}</span></div>
                    </div>
                        ...
                        @if( $log_date >= $hourly_summary['start_date'] && $log_date <= $hourly_summary['end_date'])
                            ...
                            <div id="{{$recent_log['id']}}">
                                <div class="col-xs-10" style="padding-left: 0px;">
                                    <div class="col-xs-4 control-label">@if($contract->payment_type_id == 4) wRVU Date: @else Log Date: @endif</div>
                                    <div class="col-xs-8 control-label_custom">{{$recent_log['date']}}</div>
                                    <div class="col-xs-4 control-label">@if($contract->payment_type_id == 4) Activity Name: @else Action Name: @endif</div>
                                    <div class="col-xs-8 control-label_custom">@if($recent_log['action'] != "") {{$recent_log['action']}} @else - @endif</div>
                                    <div class="col-xs-4 control-label">@if($contract->payment_type_id == 4 || $contract->payment_type_id == App\PaymentType::PER_UNIT) Units: @else Duration: @endif</div>
                                    <div class="col-xs-8 control-label_custom">@if($contract->payment_type_id == App\PaymentType::PER_UNIT) {{ round($recent_log['duration'], 0) }} @else {{(strpos($recent_log['duration'], 'Day') !== false)? str_replace('Day', '', $recent_log['duration']) : $recent_log['duration'] }} @endif
                                    ...
                                    <div class="col-xs-4 control-label">@if($contract->payment_type_id == 4) wRVU Details: @else Log Details: @endif</div>
                                    ...
                                    <div class="col-xs-2">
                                        @if($contract->payment_type_id != 4 || !is_physician())
                                            <a
                                                            ...
                                                            href=""
                                                            data-toggle="modal" data-target="#modal-confirm-edit_approve" onclick="loadApproveEditModalData({{$recent_log['id']}});"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-dismiss="modal" id="modalDeleteLog"
                                                            onClick="">Delete
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="panel-body">
                                                        <div class="col-xs-12">
                                                            <div id="enterLogMessageLog_approve_{{$recent_log['id']}}" class="alert" role="alert" style="display: none;">
                                                        ...
                                                        <div class="col-xs-12 form-group">
                                                            ...
                                                            <div class="col-xs-8">
                                                                ...
                                                                <select class="form-control" id="action_approve_{{$recent_log['id']}}" name="action" onchange="action_change_approve({{$recent_log['id']}});">
                                                                    @foreach($recent_log['actions'] as $actions)
                                                                        @if($contract->mandate_details == 1 && !$actions['override_mandate'])
                                                                            <option style='font-weight:bold;' {{$recent_log['action_id'] == $actions['id']?"selected":""}}>{{$actions['display_name']}}</option>
                                                                            ...
                                                                            ?>
                                                                        @else
                                                                            <option value="{{$actions['id']}}" id="{{$actions['id']}}" override_mandate="{{($actions['override_mandate']) ? '1' : '0'}}" time_stamp_entry="{{($actions['time_stamp_entry']) ? '1' : '0'}}" {{$recent_log['action_id'] == $actions['id']?"selected":""}}>{{$actions['display_name']}}</option>
                                                                            <?php if($recent_log['action_id'] == $actions['id']){ $action_status++; }
                                                                                if($actions['name'] == 'On-Call' || $actions['name'] == 'Called-Back' ||$actions['name'] == 'Called-In'){ $hideShift++; }
                                                                            ?>
                                                                        @endif
                                                                ...
                                                                <input class="form-control" type="text" id="custom_action_approve_{{$recent_log['id']}}" name="custom_action_{{$recent_log['id']}}"
                                                        ...
                                                        @if($recent_log['payment_type_id'] == 2)
                                                                <div class="col-xs-12 form-group co_mgmt_med_direct"  id="slider">
                                                                    ...
                                                                    <div class="col-xs-8">
                                                                        <div class="rangeSliderDiv">
                                                                            <input class="pull-left range_slider_approve" id="duration_approve_{{$recent_log['id']}}" type="range"  step="0.25"
                                                                ...
                                                                <div class="col-xs-12 form-group time_stamp_approve">
                                                                    ...
                                                                    <div id="start_timepicker_edit" class="col-xs-6 input-append">
                                                                        <input id="start_time_approve_{{$recent_log['id']}}" name="start_time" class="form-control input-small" placeholder="Start Time" type="text" 
                                                                ...
                                                                <div class="col-xs-12 form-group time_stamp_approve">
                                                                    ...
                                                                    <div id="end_timepicker_edit" class="col-xs-6 input-append">
                                                                        <input id="end_time_approve_{{$recent_log['id']}}" name="end_time" class="form-control input-small" placeholder="End Time" type="text" 
                                                        ...
                                                        <div class="col-xs-12 form-group">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <input lass="form-control" type="text" name="date" id="date_approve_{{$recent_log['id']}}" value="{{$recent_log['date']}}" disabled/>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-12 form-group">
                                                            ...
                                                            <input type="hidden" id="partial_hours_"
                                                                ...
                                                                @if($recent_log['payment_type_id'] != 7)
                                                                    ...
                                                                    <div class="col-xs-8"><textarea name="log_details" id="log_details_approve_{{$recent_log['id']}}"
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary"
                                                        onClick="reSubmitApprove({{$recent_log['id']}},{{$recent_log['log_physician_id']}});">Submit
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="col-xs-4 control-label">Action/Duty:</div>
                                                            ...
                                                            <select class="form-control" id="action_approve_{{$recent_log['id']}}" name="action" onchange="action_change_approve({{$recent_log['id']}});">
                                                                @foreach($recent_log['actions'] as $actions)
                                                                    @if($recent_log['payment_type_id'] == 1 || $recent_log['payment_type_id'] == 6)
                                                                        @if($contract->mandate_details == 1 && !$actions['override_mandate'])
                                                                            <option style='font-weight:bold;' id="{{$actions['id']}}" override_mandate="{{($actions['override_mandate']) ? '1' : '0'}}" time_stamp_entry="{{($actions['time_stamp_entry']) ? '1' : '0'}}" value="{{$actions['id']}}" {{$recent_log['action_id'] == $actions['id']?"selected":""}}>{{$actions['display_name']}}</option>
                                                                            <?php if($recent_log['action_id'] == $actions['id']){ $action_status++; }
                                                                            if($actions['name'] == 'On-Call' || $actions['name'] == 'Called-Back' ||$actions['name'] == 'Called-In'){ $hideShift++; }
                                                                            ?>
                                                                        @else
                                                        ...
                                                        @if($recent_log['payment_type_id'] == 3 || ($recent_log['payment_type_id'] == 5))
                                                            @foreach($recent_log['actions'] as $actions)
                                                                <input type="hidden" name="on_call_duration_approve_{{$actions['id']}}_{{$recent_log['id']}}" id="on_call_duration_approve_{{$actions['id']}}_{{$recent_log['id']}}" value="{{$actions['duration']}}"/>
                                                            @endforeach
                                                        @endif
                                            ...
                                            @if($recent_log['payment_type_id'] == 3 || $recent_log['payment_type_id'] == 5)
                                                @if($hideShift == 0)
                                                    <div class="col-xs-12 form-group" id="divShift_approve_{{$recent_log['id']}}">
                                                        <div class="col-xs-4 control-label">Shift:</div>
                                                        <div class="col-xs-8">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="shift_approve_{{$recent_log['id']}}" {{$recent_log['shift']==1 ? 'checked':''}} value="1" {{$recent_log['shift'] != 0 ? '':'disabled'}}> AM
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" name="shift_approve_{{$recent_log['id']}}" {{$recent_log['shift']==2 ? 'checked':''}} value="2" {{$recent_log['shift'] != 0 ? '':'disabled'}}> PM
                                                            </label>
                                                        </div>
                                                    </div>
                                                @endif
                                            ...
                                            @else
                                                @if($recent_log['payment_type_id'] == 7)
                                                    <div class="col-xs-12 form-group co_mgmt_med_direct"  id="log_slider">
                                                        <div class="col-xs-4 control-label">Duration: <br/>(Hours) &nbsp;</div>
                                                        <div class="col-xs-4">
                                                            <input id="duration_approve_{{$recent_log['id']}}" value="{{$recent_log['duration']}}" class="form-control" type="text" name="date" onkeypress="timeStudyValidation(event, this)" maxlength="5" autocomplete="off" placeholder="Hours"/>
                                                        </div>
                                            ...
                                            <div class="col-xs-12 form-group">
                                                <div class="col-xs-4 control-label">Date: </div>
                                                <div class="col-xs-8">
                                                    <input class="form-control" type="text" name="date" id="date_approve_{{$recent_log['id']}}" value="{{$recent_log['date']}}" disabled/>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 form-group">
                                                <input type="hidden" id="contract_type_approve_{{$recent_log['id']}}"
...
function loadApproveEditModalData(id)
{
  $('#modal-confirm-edit_approve'+id+' .modal-dialog').find('.rangeSliderDiv').each(function(){
    $(this).find('.rangeSlider').each(function(){$(this).remove();});});
        ...
        if(!mandate_details || override_mandate_details_flag) {
            $.ajax({
                ...
                if(response.status == 1) {
                    ...
                    // getRecentLogs(physicianid, $('#contract_id').val());
                    // getPendingForApprovalLogs(physicianid, $('#contract_id').val())
