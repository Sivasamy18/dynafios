@if (count($items) > 0)
<table class="table table-striped table-hover physician-reports-table">
    <thead>
    <tr>
    ...
    <tr>
        <td>
            <a href="{{ URL::route('physicians.report', [ $physician->id, $report->id]) }}">
        ...
        <td class="text-right rowlink-skip">
            <div class="btn-group btn-group-xs">
                <a class="btn btn-default btn-delete"
                   href="{{ URL::route('physicians.delete_report', [ $physician->id, $report->id ]) }}">
