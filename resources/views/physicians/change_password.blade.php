...
<div class="page-header">
    <h3>
        <i class="fa fa-user fa-fw icon"></i> Settings - {{ "$physician->first_name $physician->last_name" }}
    </h3>
    <div class="btn-group btn-group-sm">
        <a class="btn btn-default" href="{{ URL::route('users.show',  Auth::user()->id) }}">
...
<div class="panel panel-default">
    ...
    <div class="form-group">
            ...
            <div class="col-xs-1">
                <span class="fa fa-fw fa-eye toggle-current-password"></span>
            </div>
            <div class="col-xs-5">
                {!! $errors->first('current_password', '<p class="validation-error">:message</p>') !!}
            </div>
        </div>
        <div class="form-group">
