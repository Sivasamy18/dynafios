...
{{ Form::open([ 'class' => 'form form-horizontal form-edit-interface-type' ]) }}
{{ Form::hidden('id', $interfaceType->id )}}
<div class="panel panel-default">
    <div class="panel-heading">Edit Interface Type</div>
    <div class="panel-body">
        <div class="form-group">
            <label class="col-xs-2 control-label">Name</label>

            <div class="col-xs-5">
                {{ Form::text('name', Request::old('name', $interfaceType->name), [ 'class' => 'form-control' ]) }}
            </div>
