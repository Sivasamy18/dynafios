...
{{ Form::open([ 'class' => 'form form-horizontal form-create-specialty' ]) }}
<div class="panel panel-default">
    <div class="panel-heading">Create Specialty</div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <div class="input-group">
                    {{ Form::text('fmv_rate', Request::old('fmv_rate'), [ 'class' => 'form-control' ]) }}
