<div class="form-wrapper" style="position: relative;">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group" style="border-top: 1px solid #ddd; padding-top: 10px;">
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-4"><label>Period Start</label></div>
                    <div class="col-xs-4"><label>Period End</label></div>
                </div>
            </div>
        ...
        <div class="panel-footer clearfix">
            ...
            <button id="btn_submit_1" class="btn btn-primary btn-sm" onClick="submitreport()">Submit</button>
        </div>
    </div>
