    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-xs-5">
                    {{ Form::select('attestation_type', $attestation_types, Request::old('attestation_type', $attestation_type), [ 'id'=>'attestation_type', 'class' =>'form-control' ]) }}
                </div>
            </div>
			<div class="form-group">
        ...
        <div class="panel-footer clearfix">
            ...
            <button class="btn btn-primary btn-sm btn-submit testing">Submit</button>
        </div>
    </div>
