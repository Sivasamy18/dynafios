Dashboard = {
    ...
    global: function() {
        ...
        $(".add-note").on('click', function(event) {
            ...
            var note = '<div class="form-group invoive-note">  <label class="col-xs-2 control-label">Invoice Note '+note_number+'</label>'
                    +'<div class="col-xs-5"><textarea class="form-control" id="note'+note_number+'" maxlength="50" rows="2" cols="54" style="resize:none" name="note'+note_number+'" spellcheck="false"></textarea></div>'
                    +'<div class="col-xs-2"><button class="btn btn-primary btn-submit remove-note" type="button"> - </button></div></div>';
            $('#notes').append(note);
